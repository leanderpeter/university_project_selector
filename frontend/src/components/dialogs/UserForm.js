...
class UserForm extends Component {
    ...
    updateUser = () => {
        ...
        ElectivAPI.getAPI().updateUser(user.id,this.state.name,this.state.mat_nr).then(user => {
                ...
                <Dialog open={show} onEnter={this.getInfos} onClose={this.handleClose} maxWidth='xs' fullWidth>
                    ...
                    <DialogContent>
                        ...
                        <LoadingProgress show={addingInProgress || updatingInProgress} />
                        {
                            ...
                            <ContextErrorMessage error={updatingError} contextErrorMsg={`The User ${user.getID()} could not be updated.`} onReload={this.updateUser} />
