...
class SignIn extends Component {
    ...
    render() {
        ...
        return <div>
            <Paper>
                <Card>
                    <Typography className={classes.root} align='center' variant='h6'>Willkommen zur HDM Wahlfach
                        App</Typography>
                    <Grid container justify='center'>
                        <Grid item>
                            ...
                            {rolle === 'Student' ?
                                <>
                                    <form className={classes.form} autoComplete="on">
                                        <TextField id="kuerzel" label="Kürzel" error={kuerzelValidationFailed}
                                                   onChange={this.textFieldValueChange}/>
                                    </form>
                                    <form className={classes.form} autoComplete="on">
                                        <TextField id="mat_nr" label="Matrikelnummer" error={mat_nrValidationFailed}
